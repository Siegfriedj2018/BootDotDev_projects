...
INSERT INTO posts (
    ...
    $7,
    $8
) RETURNING id, created_at, update_at, title, url, description, published_at, feed_id
`
...
SELECT feed_follow.id, feed_follow.created_at, feed_follow.updated_at, feed_follow.user_id, feed_follow.feed_id, users.name AS user_name, feeds.name AS feed_name
FROM feed_follow
...
SELECT posts.id, posts.created_at, posts.update_at, posts.title, posts.url, posts.description, posts.published_at, posts.feed_id, feeds.name AS feed_name FROM posts
